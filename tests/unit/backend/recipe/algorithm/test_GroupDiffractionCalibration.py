...
class TestGroupDiffractionCalibration(unittest.TestCase):
    ...
    def test_chop_ingredients(self):
        ...
        assert algo.dMin == self.fakeIngredients.focusGroup.dMin
        assert algo.dMax == self.fakeIngredients.focusGroup.dMax
        assert algo.dBin == self.fakeIngredients.focusGroup.dBin
        assert algo.TOFBin == min([abs(db) for db in self.fakeIngredients.focusGroup.dBin])
