...
#     assert len(localDataService.calibrationIndex("123", True).index) == 0
...
#     localDataService._constructCalibrationStateRoot = mock.Mock()
#     localDataService._constructCalibrationStateRoot.return_value = Resource.getPath("outputs")
#     assert len(localDataService.normalizationIndex("123", True).index) == 0
...
#         CalibrationIndexEntry(runNumber="57514", useLiteMode=True, comments="test comment", author="test author"),
#     )
#     actualEntries = localDataService.calibrationIndex("57514", True).index
#     os.remove(expectedFilePath)
...
#         )
#     )
#     actualEntries = localDataService.normalizationIndex("57514", True).index
#     os.remove(expectedFilePath)
...
#         indexor = Indexor(type=IndexorType.CALIBRATION, path=basePath)
#         localDataService.indexor[("x", True, indexor.indexorType)] = indexor
...
#         localDataService = LocalDataService()
#         indexor = Indexor(path=tempdir, type=IndexorType.NORMALIZATION)
#         localDataService.indexor = mock.Mock(return_value=indexor)
#         # localDataService.normalizationIndex = mock.Mock()
#         # localDataService.instrumentConfig = mock.Mock()
#         # localDataService._generateStateId = mock.Mock()
#         # localDataService._generateStateId.return_value = ("ab8704b0bc2a2342", None)
...
#     actualPath = localDataService.normalizationIndex("57514", True). recordPath(testVersion) #RecordPath("57514", True, testVersion)
...
#     localDataService = LocalDataService()
#     localDataService.calibrationIndex = mock.Mock()
...
#             localDataService = LocalDataService()
#             localDataService._generateStateId = mock.Mock(return_value=("123", "456"))
#             indexor = Indexor(type=IndexorType.CALIBRATION, directory=tmpDir)
#             localDataService.indexor[("123", True, IndexorType.CALIBRATION)] = indexor
...
#             calibrationDataPath = indexor.versionPath(1)
#             calibrationDataPath.mkdir(parents=True)
#             calibrationParametersFilePath = indexor.parametersPath(1)
#             write_model_pretty(calibration, calibrationParametersFilePath)
...
#             localDataService.writeCalibrationState(calibration, 1)
