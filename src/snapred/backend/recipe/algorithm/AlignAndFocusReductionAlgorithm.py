...
class AlignAndFocusReductionAlgorithm(PythonAlgorithm):
    ...
    def loadNexus(self, Filename, OutputWorkspace):
        self.enqueueAlgorithm(
            "LoadNexus",
            "Loading Nexus for {} ...".format(Filename),
            False,
            Filename=Filename,
            OutputWorkspace=OutputWorkspace,
        )
    ...
    def loadDiffCal(self, Filename, InputWorkspace, WorkspaceName):  # noqa: ARG002
        self.enqueueAlgorithm(
            ...
            False,
            InstrumentFilename="/SNS/SNAP/shared/Calibration/PixelGroupingDefinitions/SNAPLite.xml",
            Filename="/SNS/SNAP/shared/Calibration/14100-10/SNAP048705_calib_geom_20220907.lite.h5",
    ...
    def createGroupWorkspace(self, StateConfig, InstrumentName, CalibrantWorkspace):
        self.enqueueAlgorithm(
            ...
            CalibrantWorkspace=CalibrantWorkspace,
    ...
    def generatePythonScript(self, InputWorkspace, Filename):
        self.enqueueAlgorithm(
            "GeneratePythonScript", "Generating Script", False, InputWorkspace=InputWorkspace, Filename=Filename
        )
