...
LiveDataArgs = NamedTuple("LiveDataArgs", [("duration", datetime.timedelta),])
                ...
                case "neutron":
                    ...
                    if v.get("liveDataArgs") is not None:
                        ...
                        if duration < datetime.timedelta(seconds=0):
                            raise ValueError("live-data args 'duration' must be >= 0 seconds; zero indicates load all available data")
